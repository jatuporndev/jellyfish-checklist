...
import '../../data/models/count_data.dart';
...
abstract class CheckListRepository {
  ...
  Future<Either<Failure, bool>> deleteCheckList(CheckListResult checkListResult);
  Future<Either<Failure, CountData>> countCheckList();
}